                        ...
                        <form action="#" class="form-profile" id="form-profile">
                            <div class="form-profile--content flex">
                                <div class="form-profile--left">
                                    ...
                                    <label class="form-profile--label flex">
                                        <span
                                            class="input-profile--info">Пароль*</span>
                                        <input
                                            class="form-profile--input form-profile--password"
                                            id="password"
                            ...
                            <li class="cards__item">
                                ...
                                <button class="card__favorite btn-reset">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        fill="none">
                                        <path
                                            d="M4.08831 3.70689C8.20606 -0.272806 14.8823 -0.272624 19 6.47004C23.1178 -0.272806 29.7939 -0.272806 33.9117 3.70689C38.0294 7.71769 38.0294 14.4648 33.9117 18.4756L19 33L4.08831 18.4756C-0.0294372 14.4648 -0.0294372 7.71769 4.08831 3.70689Z"
                                            fill="#FF4E00" stroke="#FF4E00"
                                            stroke-width="2"
                                            stroke-linejoin="round" />
                                    </svg>
                                </button>
                                <a href>
                                    <h2
                                        class="cards__title cards__title-profile">Название</h2>
                                </a>
                            </li>
                        ...
                        <div class="results-info">
                                            ...
                                            <div
                                                ...
                                                <!-- <div class="result-block">
                                                    <div
                                                        ...
                                                        <p
                                                            class="results-tests-name">Общий
                                                            тест</p>
                                                        <time
                                                            datetime="2023-12-13T20:10+03:00"
                                                            class="results-tests-date">
                                                            13.12.2023 20:10
                                                        </time>
                                                    </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody>
                                                                <tr
                                                                    class="task-table--row1">
                                                                    <td
                                                                        class="task-table-title cell-border-right">Задание
                                                                        6
                                                                    </td>
                                                                    <td
                                                                        class="task-table-cell">Верно</td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        class="task-table-title cell-border-right">Задание
                                                                    ...
                                                                    <td
                                                                        class="task-table-cell">Неверно</td>
                                                                </tr>
                                                                <tr>
                                                                    <td
                                                                        class="task-table-title cell-border-right">Задание
                                                ...
                                                <div class="result-block">
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            тест</p>
                                                        <time
                                                            datetime="2023-10-20T20:10+03:00"
                                                            class="results-tests-date">
                                                            20.10.2023 20:10
                                                        </time>
                                                    </div>
                                                ...
                                                <div class="result-block">
                                                    <div
                                                        ...
                                                        <p
                                                            ...
                                                            тест</p>
                                                        <time
                                                            datetime="2023-09-15T20:10+03:00"
                                                            class="results-tests-date">
                                                            15.09.2023 20:10
                                                        </time>
                                                    </div>
                            ...
                            <div class="results-card">
                                ...
                                <ul class="results-card--test">
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Текстовые
                                                задачи 1<i
                                                    class="card-svg plus"></i>
                                            </p>
                                        </div>

                                        <div class="results-card--hidden">
                                            <div class="card-hidden flex">
                                                <div class="card-hidden--left">
                                                    <p
                                                        class="card-hidden--name">Тема
                                                        1</p>
                                                    <p
                                                        class="card-hidden--text">Урок
                                                        не пройден</p>
                                                </div>
                                                <div>
                                                    <a href="#"
                                                        class="btn-profile">Пройти
                                                        урок</a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="results-card--hidden">
                                            <div class="card-hidden flex">
                                                <div class="card-hidden--left">
                                                    ...
                                                    <table
                                                        class="task-table task-table--topic">
                                                        <tbody>
                                                            <tr
                                                                class="task-table--row1">
                                                                <td
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Вычисления<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Координатная
                                                прямая<i
                                                    class="card-svg plus"></i>
                                            </p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p class="results-card--name">Корни
                                                и степени<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Уравнения<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Вероятность<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Графики
                                                функций<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Расчеты
                                                по формулам<i
                                                    class="card-svg plus"></i>
                                            </p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Неравенства<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Прогрессии<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Треугольники<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Окружность<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Четырехугольники<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p class="results-card--name">Фигуры
                                                на решетке<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p class="results-card--name">Анализ
                                                геометрических высказываний<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Уравнения,
                                                выражения, неравенства<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Функции
                                                и графики<i
                                                    class="card-svg plus"></i></p>
                                        </div>
                                    ...
                                    <li class="results-card--item">
                                        <div class="results-card--topic">
                                            <p
                                                class="results-card--name">Геометрические
                                                задачи на вычисление<i
                                                    class="card-svg plus"></i></p>
                                        </div>
