...
<body>
    ...
    <div class="changePasswordModal hidden-total">
        <svg class="changePassword-btn-close" width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <form action="#" class="changePasswordModal-form" id="changePasswordModal-modal">
            <label class="label-current-password changePasswordModal-label form-profile--label flex">
                <span class="input-profile--info">Текущий пароль</span>
                <input class="input-password form-profile--input form-profile--password" id="current-password" type="password" name="password" maxlength="64" required>
                <button class="btn-eye--off"></button>
                <p class="password-result password-error hidden-total">Неверный пароль</p>
            </label>
            <label class="changePasswordModal-label label-new-password form-profile--label flex">
                <span class="input-profile--info">Новый пароль</span>
                <input class="input-password form-profile--input form-profile--password" id="new-password" type="password" name="password" maxlength="64" required>
                <button class="btn-eye--off"></button>
                <p class="password-result password-success hidden-total">Пароль успешно обновлен</p>
            </label>
            <button class="btn-reset btn-form changePasswordModal-btn">Сохранить</button>
        </form>
    </div>
    ...
    <header class="wrapper header-profile flex">
        <a class="profile-logo" href="mainpage.html">
            <img src="img/logo_header.png" alt="logo"></a>
        <a class="profile-back profile-back_margin" href="mainpage.php">Главная</a>

        <div class="exit-wrap flex">
            <svg width="26" height="29" viewBox="0 0 26 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.9987 1.16797H1.33203V24.5013C1.33203 25.3854 1.68322 26.2332 2.30834 26.8583C2.93346 27.4834 3.78131 27.8346 4.66536 27.8346H17.9987M19.6654 19.5013L24.6654 14.5013M24.6654 14.5013L19.6654 9.5013M24.6654 14.5013H7.9987" stroke="#5C0C70" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
    ...
    <main>
        <div class="wrapper profile-menu flex hidden-total">
            <svg class="profile-menu--icon" width="36" height="24" viewBox="0 0 36 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 2H34M2 12H34M2 22C9.81049 22 26.1895 22 34 22" stroke="#5C0C70" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        ...
        <section class="wrapper profile flex">
            <div class="profile-left">
                <button class="btn-reset close profil-close hidden-total"></button>
                <p class="profile-fio"></p>
                <div class="profile-list">
                    <div class="profile-card profile-card--active flex">
                        <div class="profile-left-icon">
                            <svg class="icon-svg icon-svg1 icon-svg--active" width="40" height="33" viewBox="0 0 40 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M30.9666 1.4469C24.8597 -1.65502 21.0792 1.03492 25.611 2.1012C37.0978 4.81539 40.3818 19.2045 29.3555 27.1289C16.2692 36.5074 -3.48096 23.6667 4.85547 10.6289C8.3936 5.1036 14.003 2.05275 18.0016 1.93158C21.5155 1.83464 20.4007 0.0655593 16.8141 0.0655593C7.9688 0.0655593 -1.55508 11.3343 0.21399 19.7192C1.64378 26.5773 7.26605 31.0364 15.869 32.1026C35.9104 34.5987 47.9788 10.0741 30.9666 1.4469Z" />
                                <path d="M16.3387 21.0687C15.357 19.9008 15.0461 19.399 13.8612 19.4676C12.3578 20.1285 13.3557 23.1285 16.7158 24.6597C19.9473 25.689 24.7226 25.1287 26.6527 23.4301C28.4868 21.8161 28.8548 18.3761 26.6527 19.2793C26.2205 19.4566 25.7954 19.9276 25.4704 20.4797C23.2479 24.2547 19.357 24.6597 16.3387 21.0687Z" />
                                <path d="M16.6184 12.8368C16.6184 11.1404 15.5279 10.3649 14.0254 10.995C12.6683 11.5524 12.0382 14.1212 13.0076 15.0178C14.5343 16.3991 16.6184 15.1147 16.6184 12.8368Z" />
                                <path d="M23.5379 12.8368C23.5379 11.1404 24.6283 10.3649 26.1308 10.995C27.4879 11.5524 28.118 14.1212 27.1487 15.0178C25.622 16.3991 23.5379 15.1147 23.5379 12.8368Z" />
                            </svg>
                        </div>
                        <p class="profile-card-title profile-card-title--active">Профиль</p>
                    </div>

                    <div class="profile-card flex">
                        <div class="profile-left-icon">
                            <svg class="icon-svg icon-svg2 icon-svg--especial" width="44" height="40" viewBox="0 0 44 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M16 13.5C17.5 2.5 26 5 28 2C33.04 5.80207 36.2188 7.77028 42.5 11M16 13.5C7.5 12 4 23 2 24.5M16 13.5L29 24.7667M31 26.5C32.5 25 31.1113 24.7773 32 23C32.4122 22.1757 34.2509 20.7268 36.5 19.5C39.0669 18.0999 42 17 42 17C41.0039 15.1616 41.5807 13.6 42.5 11M31 26.5C29 28 29.5 26.5 27.5 27C25.5 27.5 16 36.5 16 36.5M31 26.5L29 24.7667M42.5 11C40 14 28.5 12 29 24.7667M2 24.5C6.95856 28.0015 10.195 30.122 13.695 33.852M2 24.5C3 25.5 3.5 26.5 3.5 26.5L16 36.5M16 36.5C15.2066 35.5239 14.4447 34.651 13.695 33.852M29 24.7667C20.5 20 18.5 32.5 13.695 33.852" stroke-width="2" stroke-linejoin="round" />
                                <path d="M18.2799 5.25691C17.7339 5.72886 17.2324 6.30283 17 7C19.5 6 21 7.5 25.5 11.5L25.0239 9.11961C25.0115 9.05773 25.0589 9 25.122 9H27.5L21.7736 5.18238C20.7116 4.47438 19.2455 4.42225 18.2799 5.25691Z" fill="#FFD983" stroke="#FFD983" />
                            </svg>
                        </div>
            ...
            <div class="profile-right">
                <div class="profile-content profile-content--active profile-content--about">
                        ...
                        <div class="form-profile--content flex">
                            <div class="form-profile--left">
                                <label class="form-profile--label flex">
                                    <span class="input-profile--info">Фамилия*</span>
                                    <input class="form-profile--input input-profile--text input-profile--clear" id="surname" type="text" name="surname" placeholder="Введите фамилию" maxlength="100" required>
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>

                                <label class="form-profile--label flex">
                                    <span class="input-profile--info">Имя*</span>
                                    <input class="form-profile--input input-profile--text input-profile--clear" id="name" type="text" name="name" placeholder="Введите имя" maxlength="100" required>
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>

                                <label class="form-profile--label flex">
                                    <span class="input-profile--info">E-mail*</span>
                                    <input class="form-profile--input input-profile--mail input-profile--clear" id="email" type="email" name="email" placeholder="Введите E-mail" maxlength="256" required>
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>
                            ...
                            <div class="form-profile--right">
                                <label class="form-profile--label flex">
                                    ...
                                    <input class="form-profile--input input-city input-profile--clear" id="city" type="text" name="city" placeholder="Введите ваш город" maxlength="50">
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>

                                <label class="form-profile--label flex">
                                    <span class="input-profile--info">Телефон</span>
                                    <input class="form-profile--input input-profile--phone input-profile--clear" id="phone" type="tel" name="phone" placeholder="+7 (000) 000-00-00" maxlength="18">
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>

                                <label class="form-profile--label flex">
                                    <span class="input-profile--info">Название
                                        школы</span>
                                    <input class="form-profile--input input-school input-profile--clear" id="school" type="text" name="school" placeholder="Введите название школы" maxlength="200">
                                    <button class="btn-clear btn-clear--profile hidden"></button>
                                </label>
                            </div>
                        </div>
                        <button class="btn-reset btn-profile btn-profile_save">Сохранить</button>
                    </form>
                </div>
                ...
                <div class="profile-content profile-content--favourite">
                    ...
                    <div class="favorite-btn-wrap flex">
                        <button class="btn-reset favorite-btn favorite-btn-show">Показать
                            больше
                            <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 2L12 12L22 2" stroke="#5C0C70" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>

                        <button class="btn-reset favorite-btn favorite-btn-hide hidden-total">Скрыть
                            <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2 12L12 2L22 12" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="results-info">
                        ...
                        <div class="results-card results-card--active">
                            ...
                            <div class="result-with-points">
                                <p class="profile-text profile-text--test">Ниже
                                ...
                                <table class="results-table">
                                    <tbody>
                                        <tr class="results-table--row1">
                                            <td class="results-table--cell results-table--title cell-border-right">
                                                Выполнено
                                                заданий</td>
                                            <td class="results-table--cell results-table--title cell-border-right">
                                                Выполнено
                                                верно</td>
                                            <td class="results-table--cell results-table--title cell-breakword">
                                                Результативность</td>
                                        </tr>
                                ...
                                <div class="results-btn-wrap flex">
                                    <div class="btn-result">
                                        <button class="btn-reset favorite-btn result-btn-look">Посмотреть
                                            результаты
                                            <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2 2L12 12L22 2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        </button>
                                        <button class="btn-reset favorite-btn result-btn-hide hidden-total">Скрыть
                                            результаты
                                            <svg width="24" height="14" viewBox="0 0 24 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M2 12L12 2L22 12" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        ...
                                        <div class="results-tests-wrap hidden-total">
                                        </div>
                                    </div>

                                    <div class="btn-again flex">
                                        <a href="test.html" class="favorite-btn result-btn-again">Пройти
                                            тест
                                            заново</a>
                                    </div>
                                </div>
                        ...
                        <div class="results-card">
                            <p class="profile-text profile-text--margin">Ниже
